  ...
  return (
    <main className="min-h-screen max-w-4xl mx-auto px-6 py-12 space-y-24 relative">
      ...
      <nav className="sticky top-6 z-50 flex justify-center gap-4 md:gap-6 bg-zinc-900/60 backdrop-blur-md py-3 px-6 md:px-8 rounded-full border border-zinc-800 w-fit mx-auto shadow-2xl overflow-x-auto max-w-full">
        <Link href="#hero" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">Profile</Link>
        <Link href="#about" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">About</Link>
        <Link href="#skills" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">Skills</Link>
        <Link href="#education" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">Education</Link>
        ...
        <Link href="#certificates" className="text-sm font-medium text-zinc-400 hover:text-white transition-colors">Certs</Link>
      </nav>

      {/* ส่วนต่าง ๆ จัดเรียงตามลำดับโครงสร้าง Resume สากล */}
